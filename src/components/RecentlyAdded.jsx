...
const RecentlyAdded = () => {
  return (
    <div>
      <div className="font-jost text-white text-xl">RECENTLY ADDED</div>
          ...
          <div key={index} className="flex gap-4">
            {Object.keys(client.recently).map((key, idx) => {
              if (key !== "id") {
                ...
                return (
                  <div
                    className="relative w-[270px] h-36 rounded-2xl bg-white shadow-inner-clients p-4 flex items-center"
                    key={idx}
                  >
